...
public class TipoGrupoDao implements ITipoGrupoDao, Serializable {
	...
	public TipoGrupo getTipoGrupoById(int id) {
		Query query = getSessionFactory().getCurrentSession()
				.getNamedQuery(TipoGrupo.GET_TIPO_GRUPO_BY_ID)
				.setInteger("id", id);
	...
	public List<TipoGrupo> getTipoGruposByGrupo(int id) {
		Query query = getSessionFactory().getCurrentSession()
				.getNamedQuery(TipoGrupo.GET_TIPO_GRUPO_BY_GRUPO_ID)
				.setInteger("id", id);
		return (List<TipoGrupo>) query.list();
	}
	...
	// List list =
	// getSessionFactory().getCurrentSession().createQuery(query).list();
	// return list;
	// }
