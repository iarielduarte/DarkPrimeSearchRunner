			...
			try {
				...
				if (getRolService().addRol(rolAdd)) {
					...
					FacesMessage message = new FacesMessage(
							FacesMessage.SEVERITY_INFO, "Exito : ", "El Rol "
									+ rolAdd.getNombre()
									+ " se guardo con éxito :)");
					FacesContext.getCurrentInstance().addMessage(null, message);
				} else {
					FacesMessage message = new FacesMessage(
							FacesMessage.SEVERITY_ERROR, "Error : ", "El Rol "
									+ rolAdd.getNombre()
									+ " no se pudo guardo :(");
					FacesContext.getCurrentInstance().addMessage(null, message);
				}
